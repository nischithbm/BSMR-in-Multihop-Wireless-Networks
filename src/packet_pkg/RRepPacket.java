...
public class RRepPacket extends MultiHopPacket {
	...
	// Custom Constructors
	public RRepPacket(PacketType pktType,int senderIp,int destIp,int hops,BigInteger hopCountAuthenticator,HopCountAnchor hopCountAnchor,NodeIpSign nodePtr,ArrayList<NodeIpSign> nodeRevPtr,BigInteger signedData,BigInteger payload,int TTL){
	...
	public RRepPacket(PacketType pktType,int senderIp,int destIp,int hops,BigInteger hopCountAuthenticator,HopCountAnchor hopCountAnchor,ArrayList<NodeIpSign> nodePtr,ArrayList<NodeIpSign> nodeRevPtr,BigInteger signedData,BigInteger payload,int TTL){
		super(pktType,senderIp,destIp,hops,hopCountAuthenticator,hopCountAnchor,nodePtr,signedData,payload,TTL);
		this.nodeRevPtr = nodeRevPtr;
	}
	...
	public RRepPacket getClone(){
		RRepPacket newPkt = new RRepPacket();
